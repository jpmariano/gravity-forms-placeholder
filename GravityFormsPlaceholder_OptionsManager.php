...
class GravityFormsPlaceholder_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'gravity-forms-placeholder'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'gravity-forms-placeholder'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'gravity-forms-placeholder'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'gravity-forms-placeholder'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'gravity-forms-placeholder');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'gravity-forms-placeholder'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'gravity-forms-placeholder');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'gravity-forms-placeholder'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'gravity-forms-placeholder') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'gravity-forms-placeholder');
            case 'false':
                return __('false', 'gravity-forms-placeholder');

            case 'Administrator':
                return __('Administrator', 'gravity-forms-placeholder');
            case 'Editor':
                return __('Editor', 'gravity-forms-placeholder');
            case 'Author':
                return __('Author', 'gravity-forms-placeholder');
            case 'Contributor':
                return __('Contributor', 'gravity-forms-placeholder');
            case 'Subscriber':
                return __('Subscriber', 'gravity-forms-placeholder');
            case 'Anyone':
                return __('Anyone', 'gravity-forms-placeholder');
        }
        return $optionValue;
    }
